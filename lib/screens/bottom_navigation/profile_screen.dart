    ...
    return SafeArea(
      child: Scaffold(
          appBar: AppBar(
            ...
            elevation: 0,
            title: Text(getTranslated(context, LangConst.labelProfile).toString(),
                style: TextStyle(
                              ...
                              children: [
                                Visibility(
                                  ...
                                  child: ProfileMenuWidget(
                                    ...
                                    strMenuName: getTranslated(context, LangConst.walletSetting).toString(),
                                    onClick: () {
                                ...
                                ProfileMenuWidget(
                                  ...
                                  strMenuName:
                                      getTranslated(context, LangConst.screenSetting).toString(),
                                  onClick: () {
                                    Navigator.of(context).push(Transitions(
                                        transitionType: TransitionType.slideUp,
                                        curve: Curves.bounceInOut,
                                ...
                                ProfileMenuWidget(
                                  ...
                                  strMenuName:
                                      getTranslated(context, LangConst.labelYourFavorites).toString(),
                                  onClick: () {
                                    Navigator.of(context).push(Transitions(
                                        transitionType: TransitionType.fade,
                                        curve: Curves.bounceInOut,
                                ...
                                ProfileMenuWidget(
                                  ...
                                  strMenuName:
                                      getTranslated(context, LangConst.labelOrderHistory).toString(),
                                  onClick: () {
                                    Navigator.of(context).push(Transitions(
                                        transitionType: TransitionType.fade,
                                        curve: Curves.bounceInOut,
                                ...
                                ProfileMenuWidget(
                                  ...
                                  strMenuName: getTranslated(context, LangConst.labelShareWithFriends).toString(),
                                  onClick: () async{
                                ...
                                ProfileMenuWidget(
                                  ...
                                  strMenuName: getTranslated(context, LangConst.labelLogout).toString(),
                                  onClick: () {
                                    showDialog(
                                        context: context,
                                        ...
                                        builder: (BuildContext context) {
                                          return AlertDialog(
                                            title: Text(getTranslated(context, LangConst.labelConfirmLogout).toString()),
                                            content: Text(getTranslated(context, LangConst.labelAreYouSureLogout).toString()),
                                            actions: <Widget>[
                                              TextButton(
                                                child: Text(getTranslated(context, LangConst.labelYES).toString(), style: TextStyle(color: Constants.colorBlack),),
                                                onPressed: () {
                                              ...
                                              TextButton(
                                                child: Text(getTranslated(context, LangConst.labelNO).toString(), style: TextStyle(color: Constants.colorBlack),),
                                                onPressed: () {
