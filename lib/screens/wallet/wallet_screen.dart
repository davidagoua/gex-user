    ...
    return SafeArea(
      child: Scaffold(
        appBar: ApplicationToolbar(
          appbarTitle: getTranslated(context, LangConst.walletSetting).toString(),
        ),
        body: LayoutBuilder(
                                        ...
                                        Row(
                                          ...
                                          children: [
                                            Column(
                                              ...
                                              children: [
                                                Text(
                                                  getTranslated(context, LangConst.walletBalance).toString(),
                                                  style: TextStyle(
                                    ...
                                    children: <Widget>[
                                      Expanded(
                                        ...
                                        child: Column(
                                          ...
                                          children: [
                                            Text(
                                              getTranslated(context, LangConst.transactionHistory).toString(),
                                              style: TextStyle(
                                                  color: Constants.colorBlack,
                                                  fontFamily: Constants.appFontBold,
                                                  fontSize: 20),
