                                ...
                                child: Padding(
                                  ...
                                  child: TextField(
                                    ...
                                    decoration: InputDecoration(
                                      ...
                                      hintText: getTranslated(context, LangConst.labelSearchSomething).toString(),
                                      hintStyle: TextStyle(
                                        fontSize: 14,
                          ...
                          child: ListView(
                            children: [
                                      ...
                                      children: [
                                        Padding(
                                          ...
                                          child: Row(
                                            ...
                                            children: [
                                              Text(
                                                getTranslated(context, LangConst.labelRecentlySearches).toString(),
                                                style: TextStyle(
                                                  fontSize: 16,
                                                  fontFamily: Constants.appFont,
                                                ),
                                              ...
                                              InkWell(
                                                ...
                                                child: Text(
                                                  getTranslated(context, LangConst.labelClear).toString(),
                                                  style: TextStyle(
                                                      fontSize: 16,
                                                      fontFamily: Constants.appFont,
                              ...
                              Padding(
                                ...
                                child: Text(
                                  getTranslated(context, LangConst.labelSearchByCuisine).toString(),
                              ...
                              Padding(
                                padding: const EdgeInsets.only(left: 15, top: 10),
                                child: Text(
                                  getTranslated(context, LangConst.labelSearchByTopBrands).toString(),
                                  style: TextStyle(fontSize: 18.0, fontFamily: Constants.appFont),
                                ),
                              ),
                              Container(
