...
class _EditProfileInformationState extends State<EditProfileInformation> with SingleTickerProviderStateMixin {
      ...
      child: Scaffold(
        appBar: AppBar(
          ...
          bottom: TabBar(
            ...
            tabs: <Widget>[
              Tab(
                text: getTranslated(context, LangConst.labelPersonalDetails).toString(),
              ),
              Tab(
                text: getTranslated(context, LangConst.labelFinancialDetails).toString(),
              ),
            ],
          ),
        ),
                                  ...
                                  GestureDetector(
                                    child: Row(
                                      children: [
                                        ...
                                        Text(
                                          getTranslated(context, LangConst.changeProfilePicture).toString(),
                                          style: TextStyle(
                                              color: Colors.black,
                                              fontSize: 15,
                              ...
                              Padding(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    AppLableWidget(
                                      title:
                                          getTranslated(context, LangConst.labelFullName).toString(),
                                    ),
                                    CardTextFieldWidget(
                                      focus: (v) {
                                    ...
                                    AppLableWidget(
                                      title:
                                          getTranslated(context, LangConst.labelLanguage).toString(),
                                    ),
                                    ListView.builder(
                                ...
                                children: [
                                  Padding(
                                    ...
                                    child: RoundedCornerAppButton(
                                      ...
                                      btnLabel: getTranslated(context, LangConst.labelSavePersonalInfo).toString(),
                                    ),
                                  ),
                                ],
                              ),
                              ...
                              SingleChildScrollView(
                                child: Padding(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      AppLableWidget(
                                        title: getTranslated(context, LangConst.iFSCCode).toString(),
                                      ),
                                      CardTextFieldWidget(
                                        focus: (v) {
                                          FocusScope.of(context).nextFocus();
                                        ...
                                        textInputAction: TextInputAction.next,
                                        hintText:
                                            getTranslated(context, LangConst.iFSCCode1).toString(),
                                        textInputType: TextInputType.text,
                                      ...
                                      AppLableWidget(
                                        title: getTranslated(context, LangConst.mICRCode).toString(),
                                      ),
                                      CardTextFieldWidget(
                                        focus: (v) {
                                          FocusScope.of(context).nextFocus();
                                        ...
                                        textInputAction: TextInputAction.next,
                                        hintText:
                                            getTranslated(context, LangConst.mICRCode1).toString(),
                                        textInputType: TextInputType.text,
                                        textEditingController:
                                            _micrCodeController,
                                      ...
                                      AppLableWidget(
                                        title: getTranslated(context, LangConst.bankAccountName).toString(),
                                      ),
                                      CardTextFieldWidget(
                                        focus: (v) {
                                          FocusScope.of(context).nextFocus();
                                        ...
                                        textInputAction: TextInputAction.next,
                                        hintText: getTranslated(context, LangConst.bankAccountName1).toString(),
                                        textInputType: TextInputType.text,
                                        textEditingController:
                                      ...
                                      AppLableWidget(
                                        title: getTranslated(context, LangConst.bankAccountNumber).toString(),
                                      ),
                                      CardTextFieldWidget(
                                        focus: (v) {
                                          FocusScope.of(context).nextFocus();
                                        ...
                                        hintText: getTranslated(context, LangConst.bankAccountNumber1).toString(),
                                        textInputType: TextInputType.text,
                                        textEditingController:
                                      ...
                                      Padding(
                                        ...
                                        child: RoundedCornerAppButton(
                                          ...
                                          btnLabel: getTranslated(context, LangConst.labelSubmit).toString(),
                                        ),
                                      ),
                                    ],
                                  ),
  ...
  String? validateAccountNumber(String? value) {
    if (value!.trim().isEmpty) {
      return getTranslated(context, LangConst.bankAccountNumber2).toString();
    }
    return null;
  }
  ...
  String? validateAccountname(String? value) {
    if (value!.trim().isEmpty) {
      return getTranslated(context, LangConst.bankAccountName2).toString();
    }
    return null;
  }
  ...
  String? validateIFSC(String? value) {
    if (value!.trim().isEmpty) {
      return getTranslated(context, LangConst.iFSCCode2).toString();
    }
    return null;
  }
  ...
  String? validateMICRCode(String? value) {
    if (value!.trim().isEmpty) {
      return getTranslated(context, LangConst.mICRCode2).toString();
    } else
      return null;
  }
