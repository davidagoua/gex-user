...
class _WalletAddScreenState extends State<WalletAddScreen> {
  ...
  Widget build(BuildContext context) {
    return SafeArea(
      child: Scaffold(
        appBar: ApplicationToolbar(appbarTitle: '' ),
        body: LayoutBuilder(
                              ...
                              Container(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    Text(
                                      getTranslated(context, LangConst.mealUpWallet).toString(),
                                      style: TextStyle(
                                    ...
                                    Text(
                                      "${getTranslated(context, LangConst.availableMealUpBalance).toString()} ${SharedPreferenceUtil.getString(Constants.appSettingCurrencySymbol)} $balance",
                                      style: TextStyle(
                                          color: Constants.colorBlack,
                                    ...
                                    Column(
                                      ...
                                      children: [
                                        Text(
                                          getTranslated(context, LangConst.addMoney).toString(),
                                          style: TextStyle(
                                              color: Constants.colorBlack,
                                              fontFamily: Constants.appFontBold,
                                              fontSize: 20),
                                        ...
                                        TextField(
                                          ...
                                          decoration: InputDecoration(
                                            ...
                                            hintText: getTranslated(context, LangConst.enterAmount).toString(),
                                            hintStyle: TextStyle(
                                        ...
                                        Center(
                                          child: Text(
                                            getTranslated(context, LangConst.moneyWillBeAddedToMealUpWallet).toString(),
                                            style: TextStyle(
                                                color: Constants.colorBlack,
                                                fontFamily: Constants.appFont,
                                                fontSize: 14),
