    ...
    return SafeArea(
      child: Scaffold(
        appBar: ApplicationToolbarWithClrBtn(
          appbarTitle: getTranslated(context, LangConst.labelManageYourLocation).toString(),
          strButtonTitle: '+ ${getTranslated(context, LangConst.labelAddAddress).toString()}',
                                      ...
                                      child: Row(
                                        children: [
                                          GestureDetector(
                                            ...
                                            child: Text(
                                              getTranslated(context, LangConst.labelEditAddress).toString(),
                                              style: TextStyle(
                                          ...
                                          Padding(
                                            ...
                                            child: GestureDetector(
                                              ...
                                              child: Text(
                                                getTranslated(context, LangConst.labelRemoveThisAddress).toString(),
                                                style: TextStyle(
                ...
                child: Column(
                  ...
                  children: [
                    Row(
                      ...
                      children: [
                        Text(
                          getTranslated(context, LangConst.labelRemoveAddress).toString(),
                          style: TextStyle(
                            fontSize: 18,
