                        ...
                        child: RichText(
                          text: TextSpan(
                            children: [
                              ...
                              TextSpan(
                                text:
                                    getTranslated(context, LangConst.labelSearchLocation).toString(),
                                style: TextStyle(
                      ...
                      Padding(
                        ...
                        child: RoundedCornerAppButton(
                          ...
                          btnLabel: widget.isFromAddAddress
                              ? getTranslated(context, LangConst.labelAddAddress).toString()
  ...
  Future<BaseModel<CommenRes>> callAddUserAddress(strAddressLabel) async {
    ...
    try {
      ...
      if (response.success!) {
        ...
        Constants.toastMessage(
            getTranslated(context, LangConst.labelErrorWhileAddAddress).toString());
      }
