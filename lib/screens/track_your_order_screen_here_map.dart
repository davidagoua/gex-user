    ...
    return SafeArea(
      child: Scaffold(
        ...
        appBar: ApplicationToolbarWithClrBtn(
          appbarTitle: '',
          strButtonTitle: getTranslated(context, LangConst.labelViewOrderDetails).toString(),
                  ...
                  Timeline(
                    children: <Widget>[
                      Padding(
                        ...
                        child: Text(
                          getTranslated(context, LangConst.labelFoodBeingPrepared).toString(),
                          style: TextStyle(
                            fontSize: 14,
                        ...
                        child: Column(
                          ...
                          children: [
                            Padding(
                              ...
                              child: Text(
                                getTranslated(context, LangConst.labelFoodReadyPickup).toString(),
                                style: TextStyle(
                                  fontSize: 14,
                                  fontFamily: Constants.appFont,
                                ),
                                      ...
                                      child: Expanded(
                                        child: Row(
                                          ...
                                          children: [
                                            ...
                                            InkWell(
                                              onTap: () {
                                                launchUrl(Uri.parse("tel://${widget.vendorNumber}"));
                                              },
                                              child: Padding(
