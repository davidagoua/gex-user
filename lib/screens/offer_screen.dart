...
class _OfferScreenState extends State<OfferScreen> {
  ...
  void initState() {
    super.initState();
    Constants.checkNetwork().whenComplete(() => callGetPromocodeListData(widget.restaurantId));
  }
  ...
  Widget build(BuildContext context) {
    ...
    return SafeArea(
        child: Scaffold(
          appBar: AppBar(
            title:Text(getTranslated(context, LangConst.labelFoodOfferCoupons).toString()),
          ),
          body: LayoutBuilder(
                        ...
                        child: Padding(
                          ...
                          child: TextField(
                            ...
                            decoration: InputDecoration(
                              ...
                              colorFilter: Constants.colorGray.toColorFilter,
                                ),
                              ),
                              hintText: getTranslated(context, LangConst.labelSearchRestOrCoupon).toString(),
                              hintStyle: TextStyle(
                                      ...
                                      children: [
                                        ...
                                        Padding(
                                          padding: EdgeInsets.only(
                                              top: 12),
                                          child: Text(
                                            '${getTranslated(context, LangConst.labelValidUpTo).toString()} ${_searchListPromoCode[index].startEndDate!.substring(_searchListPromoCode[index].startEndDate!.indexOf(" - ") + 1)}',
                                            style: TextStyle(
                                                color:
                                                Constants.colorGray,
                                                fontFamily:
