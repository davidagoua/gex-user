                        ...
                        children: [
                          ...
                          Padding(
                            ...
                            child: RoundedCornerAppButton(
                                      ...
                                      Navigator.of(context).push(
                                        Transitions(
                                          ...
                                          widget: PaymentStripe(
                                            ...
                                            ordrePromoCode: widget.orderPromoCode,
                              ...
                              btnLabel:
                                  getTranslated(context, LangConst.labelPlaceYourOrder).toString(),
                            ),
                          ),
                        ],
                      )),
  ...
  Future<BaseModel<CommenRes>> placeOrder() async {
    ...
    try{
      ...
      if(widget.isPromocodeApplied){
        ...
        'promocode_id': widget.orderPromoCode,
