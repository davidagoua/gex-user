              ...
              child: Row(
                ...
                children: [
                  Padding(
                    ...
                    child: Text(
                      '${getTranslated(context, LangConst.labelTotalItem).toString()} $totalQty' +
                  ...
                  Padding(
                    ...
                    child: RichText(
                      text: TextSpan(
                        children: [
                          TextSpan(
                            text: getTranslated(context, LangConst.labelContinue).toString(),
                            style: TextStyle(
                                color: Constants.colorWhite,
                                fontFamily: Constants.appFont,
                              ...
                              Expanded(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    Text(
                                      '$strRestaurantsRate+ ${getTranslated(context, LangConst.labelRatings).toString()}',
                                      style: TextStyle(
                                          fontFamily: Constants.appFont,
                                          color: Constants.colorGray,
                                          fontSize: ScreenUtil().setSp(12)),
                              ...
                              Expanded(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    Text(
                                      getTranslated(context, LangConst.labelFor2Persons).toString(),
                                      style: TextStyle(
                                          fontFamily: Constants.appFont,
                                          color: Constants.colorGray,
                                          fontSize: ScreenUtil().setSp(12)),
                                    ...
                                    decoration: InputDecoration(
                                      ...
                                      suffixIcon: IconButton(
                                        ...
                                        icon: SvgPicture.asset(
                                          ...
                                          width: ScreenUtil().setWidth(15),
                                          height: ScreenUtil().setHeight(15),
                                          colorFilter: Constants.colorBlack.toColorFilter,
                                        ),
                                      ),
                                      hintText: getTranslated(context, LangConst.labelSearchItems).toString(),
                                      hintStyle: TextStyle(
                                        fontSize: ScreenUtil().setSp(16),
                                        fontFamily: Constants.appFont,
                                        color: Constants.colorGray,
                                ...
                                GestureDetector(
                                  onTap: () {
                                    if (item.qtyReset == 'daily' &&
                                      ...
                                      Constants.toastMessage(
                                        getTranslated(context, LangConst.outOfStock).toString(),
                                      );
                                    } else {
                                      if (item.custimization!.length > 0) {
                                        var ab;
                ...
                child: Column(
                  ...
                  children: [
                    Row(
                      ...
                      children: [
                        Text(
                          getTranslated(context, LangConst.labelRemoveCartItem).toString(),
                          style: TextStyle(
                            fontSize: 18,
                            fontWeight: FontWeight.w900,
                            fontFamily: Constants.appFontBold,
                    ...
                    Column(
                      ...
                      children: [
                        ...
                        Container(
                          height: ScreenUtil().setHeight(70),
                          child: Text(
                            '${getTranslated(context, LangConst.labelYourCartContainsDishesFrom).toString()} $restName. ${getTranslated(context, LangConst.labelYourCartContains1).toString()} $currentRestName?',
                            ...
                            children: [
                              ...
                              Padding(
                                ...
                                child: GestureDetector(
                                  ...
                                  child: Text(
                                    getTranslated(context, LangConst.labelYesRemoveIt).toString(),
                                    style: TextStyle(
                                        fontSize: 14,
                                        fontWeight: FontWeight.bold,
                                        fontFamily: Constants.appFontBold,
                            ...
                            _listFinalCustomization[outerIndex].list.length > 0
                                ? _listFinalCustomizationCheck[outerIndex] == true
                                    ...
                                    : Container(
                                        ...
                                        child: Center(
                                          child: Text(
                                            getTranslated(context, LangConst.noCustomizationAvailable).toString(),
                                            style: TextStyle(
                                                fontFamily: Constants.appFontBold,
                                                fontSize: ScreenUtil().setSp(18)),
                                          ),
                          ...
                          Expanded(
                            child: InkWell(
                              ...
                              child: Container(
                                ...
                                child: Center(
                                  child: Text(
                                    '${getTranslated(context, LangConst.labelItem).toString()} ${totalQty + 1}' +
                                        '  |  '
