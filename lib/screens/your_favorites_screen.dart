    ...
    return SafeArea(
      child: Scaffold(
        appBar: ApplicationToolbar(
            appbarTitle: getTranslated(context, LangConst.labelYourFavorites).toString()),
        body: SmartRefresher(
          enablePullDown: true,
                                                                      ...
                                                                      GestureDetector(
                                                                        onTap:
                                                                          ...
                                                                          if (SharedPreferenceUtil.getBool(Constants.isLoggedIn)) {
                                                                            ...
                                                                            Constants.toastMessage(getTranslated(context, LangConst.labelPleaseLoginToAddFavorite).toString());
                                                                          }
                                                                        },
                                                                        child: Container(
                                                                    ...
                                                                    Padding(
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        children: [
                                                                          ...
                                                                          Text(
                                                                            _listFavoriteData[index].distance.toString() + getTranslated(context, LangConst.labelKmFarAway).toString(),
                                                                            style: TextStyle(
                                                                              fontSize: ScreenUtil().setSp(12.0),
                ...
                child: Column(
                  ...
                  children: [
                    Row(
                      ...
                      children: [
                        Text(
                          getTranslated(context, LangConst.labelRemoveFromTheList).toString(),
                          style: TextStyle(
                            fontSize: 18,
                    ...
                    Column(
                      ...
                      children: [
                        ...
                        Text(
                          getTranslated(context, LangConst.labelAreYouSureToRemove).toString(),
