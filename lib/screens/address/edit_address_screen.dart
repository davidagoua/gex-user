...
class _EditAddressScreenState extends State<EditAddressScreen> {
  ...
  Future<BitmapDescriptor> _bitmapDescriptorFromSvgAsset(
    ...
    ui.Image image = await svgDrawableRoot.picture.toImage(width.toInt(), height.toInt());
                  ...
                  child: Column(
                    ...
                    children: [
                        ...
                        child: RichText(
                          text: TextSpan(
                            children: [
                              ...
                              TextSpan(
                                text: getTranslated(context, LangConst.labelSearchLocation).toString(),
                                style: TextStyle(
                      ...
                      Padding(
                        padding: const EdgeInsets.only(top: 15),
                        child: Text(
                          getTranslated(context, LangConst.labelHouseNo).toString(),
                          style: TextStyle(
                              fontFamily: Constants.appFontBold,
                              fontSize: 16,
                              fontWeight: FontWeight.bold),
                            ...
                            child: Padding(
                              ...
                              child: TextField(
                                ...
                                decoration: InputDecoration(
                                    ...
                                    hintText: getTranslated(context, LangConst.labelTypeFullAddressHere).toString(),
                      ...
                      Padding(
                        padding: const EdgeInsets.only(top: 15),
                        child: Text(
                          getTranslated(context, LangConst.labelLandmark).toString(),
                          style: TextStyle(
                              fontFamily: Constants.appFontBold,
                              fontSize: 16,
                              fontWeight: FontWeight.bold),
                          ...
                          child: Container(
                            child: Padding(
                              ...
                              child: TextField(
                                decoration: InputDecoration(
                                  contentPadding: EdgeInsets.only(left: 10),
                                  hintText: getTranslated(context, LangConst.labelAnyLandmarkNearYourLocation).toString(),
                                  hintStyle: TextStyle(
                                    fontSize: 16,
                                    fontFamily: Constants.appFont,
                                    color: Constants.colorGray,
                      ...
                      Padding(
                        ...
                        child: RoundedCornerAppButton(
                          ...
                          btnLabel: getTranslated(context, LangConst.labelEditAddress).toString(),
                        ),
                      ),
                    ],
                  ),
                ...
                child: Column(
                  ...
                  children: [
                    Row(
                      ...
                      children: [
                        Text(
                          getTranslated(context, LangConst.labelAttachLabel).toString(),
                          style: TextStyle(
                            fontSize: 18,
                            ...
                            child: Container(
                              child: Padding(
                                ...
                                child: TextField(
                                  ...
                                  decoration: InputDecoration(
                                    contentPadding: EdgeInsets.only(left: 10),
                                    hintText: getTranslated(context, LangConst.labelAddLabelForThisLocation).toString(),
                                    hintStyle: TextStyle(
                                      fontSize: 14,
                                      fontFamily: Constants.appFont,
                                      color: Constants.colorGray,
                                  ...
                                  onTap: () {
                                    if (strSearchedAddress!.isEmpty ||
                                      ...
                                      Constants.toastMessage(
                                          getTranslated(context, LangConst.labelPleaseSearchAddress).toString());
                                    } else if (_textAddressLable.text.isEmpty) {
                                      Constants.toastMessage(
                                          getTranslated(context, LangConst.labelPleaseAddLabelForAddress).toString());
                                    } else {
                                      callUpdateUserAddress(widget.addressId);
                                    }
                                  },
                                  child: Text(
                                    getTranslated(context, LangConst.labelSaveIt).toString(),
                                    style: TextStyle(
                                        fontSize: 14,
                                        fontWeight: FontWeight.bold,
                                        fontFamily: Constants.appFontBold,
  ...
  Future<BaseModel<UpdateAddressModel>> callUpdateUserAddress(int? addressId ) async {
    ...
    try{
      ...
      if (response.success!) {
        ...
        Constants.toastMessage(getTranslated(context, LangConst.labelErrorWhileAddAddress).toString());
      }
