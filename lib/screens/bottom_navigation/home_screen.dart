...
class _HomeScreenState extends State<HomeScreen> {
  ...
  LatLng _center = LatLng(36.7783, 119.4179);
  ...
  void _onRefresh() async {
    ...
    if (SharedPreferenceUtil.getInt(Constants.appSettingBusinessAvailability) == 1) {
      ...
      Constants.toastMessage('The business is not available at this time');
    }
    if (mounted) setState(() {});
                    ...
                    child: Column(
                      ...
                      children: <Widget>[
                          ...
                          child: Container(
                            ...
                            child: ListTile(
                              leading: SvgPicture.asset(
                                ...
                                colorFilter: Constants.colorLike.toColorFilter,
                              ),
                              title: Transform(
                                transform: Matrix4.translationValues(-20, 0.0, 0.0),
                                child: Text(
                                  SharedPreferenceUtil.getString(Constants.appSettingBusinessMessage),
                                  style: TextStyle(
                        ...
                        Padding(
                          ...
                          child: Text(
                            getTranslated(context, LangConst.labelExploreTheBestCuisines).toString(),
                        ...
                        Row(
                          ...
                          children: [
                            Padding(
                              padding: const EdgeInsets.only(left: 15),
                              child: Text(
                                getTranslated(context, LangConst.labelTopRestaurantsNear).toString(),
                                style: TextStyle(fontSize: 18.0, fontFamily: Constants.appFont),
                              ),
                            ),
                            Padding(
                            ...
                            if (_nearbyListData.length == 0) {
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          ...
                                          Padding(
                                            padding: EdgeInsets.only(top: ScreenUtil().setHeight(10)),
                                            child: Text(
                                              getTranslated(context, LangConst.labelNoRestNear).toString(),
                                              textAlign: TextAlign.center,
                                              style: TextStyle(
                                                fontSize: ScreenUtil().setSp(18),
                                                fontFamily: Constants.appFontBold,
                              ...
                              return GridView.builder(
                                ...
                                gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(
                                  crossAxisCount: 2,
                                  mainAxisExtent:
                                      ScreenUtil().screenWidth / 1.1, // <== change the height to fit your needs
                                ),
                                                                ...
                                                                GestureDetector(
                                                                  onTap: () {
                                                                    if (SharedPreferenceUtil.getBool(
                                                                      ...
                                                                      Constants.toastMessage(getTranslated(context,
                                                                              LangConst.labelPleaseLoginToAddFavorite)
                                                                          .toString());
                                                                    }
                                                                  },
                                                                  child: _nearbyListData[index].like!
                                                                      ? SvgPicture.asset(
                                                                          ...
                                                                          colorFilter:
                                                                              Constants.colorLike.toColorFilter,
                                                                          width: 20,
                                                                        )
                                                                      : SvgPicture.asset(
                                                                          'images/ic_heart.svg',
                                                      ...
                                                      Row(
                                                        ...
                                                        children: [
                                                          ...
                                                          Container(
                                                            ...
                                                            child: (() {
                                                              if (_nearbyListData[index].vendorType == 'veg') {
                                                                return Row(
                                                                  children: [
                                                                    Padding(
                                                              ...
                                                              } else if (_nearbyListData[index].vendorType ==
                                                                  'non_veg') {
                                                                return Row(
                                                                  children: [
                                                                    Padding(
                                                              ...
                                                              } else if (_nearbyListData[index].vendorType == 'all') {
                                                                return Row(
                                                                  children: [
                                                                    Padding(
                                                                      padding: const EdgeInsets.only(right: 2),
                        ...
                        Row(
                          ...
                          children: [
                            Padding(
                              padding: const EdgeInsets.only(left: 15),
                              child: Text(
                                getTranslated(context, LangConst.labelTopRest).toString(),
                                style: TextStyle(fontSize: 18.0, fontFamily: Constants.appFont),
                              ),
                            ),
                            Padding(
                                                                    ...
                                                                    children: [
                                                                      ...
                                                                      Text(
                                                                        _topListData[index].distance.toString() +
                                                                            getTranslated(
                                                                                    context, LangConst.labelKmFarAway)
                                                                                .toString(),
                                                                        style: TextStyle(
                                                                          fontSize: ScreenUtil().setSp(12.0),
                                                                          fontFamily: Constants.appFont,
                                                                  ...
                                                                  children: [
                                                                    ...
                                                                    Container(
                                                                      child: Padding(
                                                                        ...
                                                                        child: (() {
                                                                          if (_topListData[index].vendorType == 'veg') {
                                                                            return Row(
                                                                              children: [
                                                                                Padding(
                                                                                  padding:
                        ...
                        Row(
                          ...
                          children: [
                            Padding(
                              padding: const EdgeInsets.only(left: 15),
                              child: Text(
                                getTranslated(context, LangConst.labelPureVegRest).toString(),
                                style: TextStyle(fontSize: 18.0, fontFamily: Constants.appFont),
                              ),
                            ),
                            Padding(
                                                              ...
                                                              children: [
                                                                ...
                                                                Row(
                                                                  ...
                                                                  children: [
                                                                    ...
                                                                    Container(
                                                                      child: (() {
                                                                        if (_vegListData[index].vendorType == 'veg') {
                                                                          return Row(
                                                                            children: [
                                                                              Padding(
                                                                                padding:
                        ...
                        Row(
                          ...
                          children: [
                            Padding(
                              padding: const EdgeInsets.only(left: 15),
                              child: Text(
                                getTranslated(context, LangConst.labelNonPureVegRest).toString(),
                                style: TextStyle(fontSize: 18.0, fontFamily: Constants.appFont),
                              ),
                            ),
                            Padding(
                                                          ...
                                                          children: [
                                                                ...
                                                                children: [
                                                                  ...
                                                                  Text(
                                                                    _nonvegListData[index].distance.toString() +
                                                                        getTranslated(context, LangConst.labelKmFarAway)
                                                                            .toString(),
                                                                    style: TextStyle(
                                                                      fontSize: ScreenUtil().setSp(12.0),
                                                                      fontFamily: Constants.appFont,
                                                            ...
                                                            Row(
                                                              ...
                                                              children: [
                                                                Container(
                                                                  child: Row(
                                                                    children: [
                                                                      RatingBar.builder(
                                                                        initialRating:
                                                                            _nonvegListData[index].rate.toDouble(),
                                                                        ignoreGestures: true,
                                                                        minRating: 1,
                                                                        direction: Axis.horizontal,
                                                                        itemSize: ScreenUtil().setWidth(12),
                                                                ...
                                                                Container(
                                                                  child: (() {
                                                                    if (_nonvegListData[index].vendorType == 'veg') {
                                                                      return Row(
                                                                        children: [
                                                                          Padding(
                                                                            padding: const EdgeInsets.only(right: 2),
                        ...
                        Padding(
                          padding: const EdgeInsets.only(left: 15),
                          child: Text(
                            getTranslated(context, LangConst.labelExploreRest).toString(),
                            style: TextStyle(fontSize: 18.0, fontFamily: Constants.appFont),
                          ),
                        ),
                        Padding(
                                                          ...
                                                          Padding(
                                                            ...
                                                            child: Row(
                                                              children: [
                                                                ...
                                                                Text(
                                                                  _exploreResListData[index].distance.toString() +
                                                                      getTranslated(context, LangConst.labelKmFarAway)
                                                                          .toString(),
                                                                  style: TextStyle(
                                                                    fontSize: ScreenUtil().setSp(12.0),
                                                              ...
                                                              Container(
                                                                child: Row(
                                                                  children: [
                                                                    RatingBar.builder(
                                                                      initialRating:
                                                                          _exploreResListData[index].rate.toDouble(),
                                                                      ignoreGestures: true,
                                                                      minRating: 1,
                                                                      direction: Axis.horizontal,
                                                                      itemSize: ScreenUtil().setWidth(12),
  ...
  Future<BaseModel<CommenRes>> callAddRemoveFavorite(int? vegRestId) async {
    ...
    try {
      ...
      if (response.success!) {
        ...
        Constants.toastMessage(getTranslated(context, LangConst.labelErrorWhileUpdate).toString());
      }
    } catch (error, stacktrace) {
      print("Exception occurred: $error stackTrace: $stacktrace");
      return BaseModel()..setException(ServerError.withError(error: error));
