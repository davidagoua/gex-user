...
class _OTPScreenState extends State<OTPScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return SafeArea(
      child: Scaffold(
        appBar: ApplicationToolbar(appbarTitle: getTranslated(context, LangConst.labelOTP).toString()),
                  ...
                  child: Column(
                    ...
                    children: [
                        ...
                        child: Column(
                          ...
                          children: [
                            Row(
                              ...
                              children: [
                                AppLableWidget(
                                  title: getTranslated(context, LangConst.labelEnterOTP).toString(),
                                ),
                                Padding(
                                  padding: EdgeInsets.only(
                            ...
                            RoundedCornerAppButton(
                                btnLabel: getTranslated(context, LangConst.labelVerifyNow).toString(),
                                onPressed: () {
                            ...
                            Row(
                              ...
                              children: [
                                Text(
                                  getTranslated(context, LangConst.labelDontReceiveCode).toString(),
                                  style:
                                ...
                                InkWell(
                                  ...
                                  child: Text(
                                    getTranslated(context, LangConst.labelResendAgain).toString(),
                                    style: TextStyle(
                      ...
                      Padding(
                        ...
                        child: Text(
                          getTranslated(context, LangConst.labelOTPBottomLine).toString(),
                          style: TextStyle(
