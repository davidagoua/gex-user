...
class _ExploreScreenState extends State<ExploreScreen> {
                ...
                child: Container(
                  ...
                  child: Scaffold(
                          ...
                          Expanded(
                            child: GestureDetector(
                              ...
                              child: Container(
                                ...
                                child: Center(
                                  child: Text(
                                    getTranslated(context, LangConst.labelApplyFilter).toString(),
                                    style: TextStyle(
                    ...
                    appBar: ApplicationToolbarWithClrBtn(
                      appbarTitle: getTranslated(context, LangConst.labelFilter).toString(),
                      strButtonTitle: getTranslated(context, LangConst.labelClear).toString(),
                      ...
                      child: Padding(
                        ...
                        child: SingleChildScrollView(
                          child: Column(
                            ...
                            children: [
                              Text(
                                getTranslated(context, LangConst.labelSortingBy).toString(),
                                style: TextStyle(
                                    fontFamily: Constants.appFont,
                              ...
                              Text(
                                getTranslated(context, LangConst.labelQuickFilters).toString(),
                                style: TextStyle(
                                    fontFamily: Constants.appFont,
                                    fontSize: ScreenUtil().setSp(18)),
                              ),
                              ...
                              Text(
                                getTranslated(context, LangConst.labelCousines).toString(),
                                style: TextStyle(
                                    fontFamily: Constants.appFont,
                                    fontSize: ScreenUtil().setSp(18)),
                              ),
  ...
  void getSortByList() {
    _listSortBy.clear();
    _listSortBy.add(getTranslated(context, LangConst.labelHighToLow).toString());
    _listSortBy.add(getTranslated(context, LangConst.labelLowToHigh).toString());
  }

  void getQuickFilterList() {
    _listQuickFilter.clear();
    _listQuickFilter.add(getTranslated(context, LangConst.labelVegRestaurant).toString());
    _listQuickFilter.add(getTranslated(context, LangConst.labelNonVegRestaurant).toString());
    _listQuickFilter.add(getTranslated(context, LangConst.labelBothVegNonVeg).toString());
  }
                                                                ...
                                                                onTap: () {
                                                                  if (SharedPreferenceUtil.getBool(
                                                                    ...
                                                                    Constants.toastMessage(
                                                                        getTranslated(context, LangConst.labelPleaseLoginToAddFavorite).toString());
                                                                  }
                                                                },
                                                                child:
                                                                    Container(
                                                                ...
                                                                children: [
                                                                  ...
                                                                  Text(
                                                                    _exploreResListData[index]
                                                                            .distance
                                                                            .toString() +
                                                                        getTranslated(context, LangConst.labelKmFarAway).toString(),
                                                                    style:
                                                                        TextStyle(
                                                                      fontSize:
