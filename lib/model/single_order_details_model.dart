...
class Data {
  ...
  Data.fromJson(Map<String, dynamic> json) {
    ...
    tax = json['tax'] != null ? num.parse(json['tax'].toString()) : 0;
    deliveryPersonId = json['delivery_person_id'];
    orderStatus = json['order_status'];
    deliveryCharge = json['delivery_charge'];
    addressId = json['address_id'];
    promoCodeId = json['promocode_id'];
    promoCodePrice = json['promocode_price'] != null
        ? double.parse(json['promocode_price'].toString())
        : 0.0;
    userId = json['user_id'];
    vendorDiscountPrice = json['vendor_discount_price'] != null
        ? double.parse(json['vendor_discount_price'].toString())
        : 0.0;
...
class Vendor {
  ...
  Vendor.fromJson(Map<String, dynamic> json) {
    ...
    image = json['image'];
    lat = json['lat'];
    tax = json['tax'] != null ? num.parse(json['tax']) : 0;
    lang = json['lang'];
